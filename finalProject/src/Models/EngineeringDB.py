...
@author: pyroshow
'''
from sqlalchemy import Column, Integer, Sequence, String, create_engine, DateTime, Text
...
class FireworksData(base):
    ...
    def __init__(self, UUID = None, ITime = None, MTime = None, IgnitionTime = None, FireworkID = None, 
                 IgnitorID = None, ConnectorID = None, Location = None, Angle = None, Notes = None):
