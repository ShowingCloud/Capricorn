...
#
# Created: Tue Apr 02 09:39:20 2013
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_progress.setGeometry(QtCore.QRect(150, 120, 170, 20))
        ...
        self.checkBoxMusic.setGeometry(QtCore.QRect(130, 410, 130, 25))
        ...
        self.pushButtonSoundTrack.setGeometry(QtCore.QRect(260, 440, 60, 25))
        ...
        self.labelCues = QtGui.QLabel(self.groupBox_project)
        self.labelCues.setGeometry(QtCore.QRect(10, 310, 100, 25))
        self.labelCues.setMinimumSize(QtCore.QSize(100, 25))
        self.labelCues.setMaximumSize(QtCore.QSize(80, 25))
        self.labelCues.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.labelCues.setObjectName("labelCues")
        ...
        #
        self.lineEditDurationMin.setText('5')
        self.labelDurationMin = QtGui.QLabel(self.groupBox_project)
        self.labelDurationMin.setGeometry(QtCore.QRect(180, 390, 20, 25))
        ...
        self.lineEditDurationSec.setGeometry(QtCore.QRect(200, 390, 50, 25))
        ...
        #
        self.lineEditDurationSec.setText('0')
        self.labelDurationSec = QtGui.QLabel(self.groupBox_project)
        self.labelDurationSec.setGeometry(QtCore.QRect(250, 390, 20, 25))
        ...
        self.pushButtonImport.setGeometry(QtCore.QRect(290, 20, 60, 25))
        ...
        self.lineEditCues = QtGui.QLineEdit(self.groupBox_project)
        self.lineEditCues.setGeometry(QtCore.QRect(130, 310, 50, 25))
        self.lineEditCues.setMinimumSize(QtCore.QSize(50, 25))
        self.lineEditCues.setMaximumSize(QtCore.QSize(50, 25))
        self.lineEditCues.setObjectName("lineEditCues")
        self.labelLanguage = QtGui.QLabel(self.groupBox_project)
        self.labelLanguage.setGeometry(QtCore.QRect(200, 310, 55, 25))
        ...
        self.comboBoxLanguage.setGeometry(QtCore.QRect(260, 310, 80, 25))
        self.comboBoxLanguage.setMinimumSize(QtCore.QSize(80, 25))
        self.comboBoxLanguage.setMaximumSize(QtCore.QSize(80, 25))
    ...
    def retranslateUi(self, Dialog):
        ...
        #self.label_progress.setText(QtGui.QApplication.translate("Dialog", "Entering...", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.labelCues.setText(QtGui.QApplication.translate("Dialog", "Cues Per Module:", None, QtGui.QApplication.UnicodeUTF8))
