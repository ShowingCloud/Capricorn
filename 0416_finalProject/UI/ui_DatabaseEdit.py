...
class Ui_DatabaseDialog(object):
    ...
    def retranslateUi(self, DatabaseDialog):
        ...
        self.comboBoxType.setItemText(0, QtGui.QApplication.translate("DatabaseDialog", "A", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBoxType.setItemText(1, QtGui.QApplication.translate("DatabaseDialog", "B", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBoxType.setItemText(2, QtGui.QApplication.translate("DatabaseDialog", "C", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBoxType.setItemText(3, QtGui.QApplication.translate("DatabaseDialog", "D", None, QtGui.QApplication.UnicodeUTF8))
