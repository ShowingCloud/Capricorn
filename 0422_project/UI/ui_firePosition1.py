...
class Ui_FirePositionDialog(object):
    def setupUi(self, FirePositionDialog):
        ...
        self.lineEditPositionX.setValidator(intVal)
        ...
        self.lineEditPositionY.setValidator(intVal)
        ...
        self.lineEditPositionZ.setValidator(intVal)
        ...
        self.comboBoxIgnitionBoxID.addItem("")
        self.comboBoxIgnitionBoxID.addItem("")
        self.comboBoxIgnitionBoxID.setEditable(True)
