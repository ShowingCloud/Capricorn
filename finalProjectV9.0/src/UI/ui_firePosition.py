...
#
# Created: Fri Apr 12 16:00:58 2013
...
class Ui_FirePositionDialog(object):
    def setupUi(self, FirePositionDialog):
        ...
        FirePositionDialog.resize(561, 420)
        FirePositionDialog.setMinimumSize(QtCore.QSize(561, 420))
        FirePositionDialog.setMaximumSize(QtCore.QSize(561, 420))
        FirePositionDialog.setStyleSheet("background-color: rgb(192, 192, 192);")
        self.pushButtonAdd = QtGui.QPushButton(FirePositionDialog)
        self.pushButtonAdd.setGeometry(QtCore.QRect(150, 380, 65, 30))
        self.pushButtonAdd.setObjectName("pushButtonAdd")
        self.pushButtonClone = QtGui.QPushButton(FirePositionDialog)
        self.pushButtonClone.setGeometry(QtCore.QRect(80, 380, 60, 30))
        self.pushButtonClone.setObjectName("pushButtonClone")
        self.pushButtonDelete = QtGui.QPushButton(FirePositionDialog)
        self.pushButtonDelete.setGeometry(QtCore.QRect(10, 380, 60, 30))
        self.pushButtonDelete.setObjectName("pushButtonDelete")
        self.listWidgetPosition = QtGui.QListWidget(FirePositionDialog)
        self.listWidgetPosition.setGeometry(QtCore.QRect(10, 20, 201, 351))
        ...
        self.groupBoxField.setGeometry(QtCore.QRect(220, 10, 331, 211))
        ...
        self.lineEditName.setGeometry(QtCore.QRect(100, 20, 190, 25))
        ...
        self.comboBoxReference.setGeometry(QtCore.QRect(100, 150, 190, 25))
        ...
        self.pushButtonDone.setGeometry(QtCore.QRect(380, 380, 60, 30))
        self.pushButtonDone.setObjectName("pushButtonDone")
        self.pushButtonCancel = QtGui.QPushButton(FirePositionDialog)
        self.pushButtonCancel.setGeometry(QtCore.QRect(450, 380, 60, 30))
        self.pushButtonCancel.setObjectName("pushButtonCancel")
        self.pushButtonHelp = QtGui.QPushButton(FirePositionDialog)
        self.pushButtonHelp.setGeometry(QtCore.QRect(520, 380, 30, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setWeight(75)
        font.setBold(True)
        ...
        self.groupBoxIgnition.setGeometry(QtCore.QRect(220, 230, 331, 141))
        self.groupBoxIgnition.setObjectName("groupBoxIgnition")
        self.labelIgnitionBoxID = QtGui.QLabel(self.groupBoxIgnition)
        self.labelIgnitionBoxID.setGeometry(QtCore.QRect(10, 20, 50, 25))
        ...
        self.labelIgnitionPoints.setGeometry(QtCore.QRect(10, 60, 50, 25))
        ...
        self.comboBoxIgnitionBoxPoints.setGeometry(QtCore.QRect(60, 60, 70, 25))
        self.comboBoxIgnitionBoxPoints.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.lineEditIgnitionBox.setGeometry(QtCore.QRect(60, 20, 70, 25))
        ...
        self.labelWarning = QtGui.QLabel(self.groupBoxIgnition)
        self.labelWarning.setGeometry(QtCore.QRect(230, 20, 80, 25))
        ...
        self.tableViewIgnitor = QtGui.QTableView(self.groupBoxIgnition)
        self.tableViewIgnitor.setGeometry(QtCore.QRect(150, 20, 171, 111))
        self.tableViewIgnitor.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.tableViewIgnitor.setObjectName("tableViewIgnitor")
        self.pushButtonAddBox = QtGui.QPushButton(self.groupBoxIgnition)
        self.pushButtonAddBox.setGeometry(QtCore.QRect(70, 100, 60, 25))
        self.pushButtonAddBox.setObjectName("pushButtonAddBox")
    ...
    def retranslateUi(self, FirePositionDialog):
        ...
        self.pushButtonAdd.setText(QtGui.QApplication.translate("FirePositionDialog", "Add field", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.labelIgnitionBoxID.setText(QtGui.QApplication.translate("FirePositionDialog", "Box ID:", None, QtGui.QApplication.UnicodeUTF8))
        self.labelIgnitionPoints.setText(QtGui.QApplication.translate("FirePositionDialog", "Points:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pushButtonAddBox.setText(QtGui.QApplication.translate("FirePositionDialog", "Add Box", None, QtGui.QApplication.UnicodeUTF8))
