...
#        addColumn(connection, "Fireworks", "test2", "Integer default 1")
    ...
    if older[0] < 0.3:
        ...
        addColumn(connection, "Fireworks", "test3", "Integer default 0")
        
        connection.execute("update  Version set Version = 0.3 where ID = 1") 
#    if older[0] < 0.4:
#        
#        addColumn(connection, "Fireworks", "test3", "varchar(20)")
#        
#        connection.execute("update  Version set Version = 0.4 where ID = 1") 
#    if older[0] < 0.5:
#        
#        addColumn(connection, "Fireworks", "test4", "varchar(20)")
#        
#        connection.execute("update  Version set Version = 0.5 where ID = 1") 
#    if older[0] < 0.6:
#        
#        addColumn(connection, "Fireworks", "test5", "varchar(20)")
#        
#        connection.execute("update  Version set Version = 0.6 where ID = 1") 
#    if older[0] < 0.7:
#        
#        addColumn(connection, "Fireworks", "test6", "varchar(20)")
#        
