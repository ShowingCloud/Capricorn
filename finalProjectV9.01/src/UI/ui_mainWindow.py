...
#        self.toolBar.addAction(self.actionProjectSave_as)
        ...
        self.widget_wave.upAndDownWaveWidget.plotWidget.figure.signal.currentFireworks.connect(self.widgetDatabase.script.setCurrentFireworksTop)
#        self.widget_wave.upAndDownWaveWidget.plotWidget.figure.signal..connect(self.widgetDatabase.fireworksA.getTime333)
...
#         self.widget_wave.upAndDownWaveWidget.upperPlotWidget.plotWidget.figure.signal.freshScreenTime.connect(self.widgetDatabase.customFireworks.getTime)
        ...
        self.actionPlay.triggered.connect(self.widget_wave.player.media.play)
        self.actionPause.triggered.connect(self.widget_wave.player.media.pause)
        self.actionPause.triggered.connect(self.widget_wave.player.media.stop)
