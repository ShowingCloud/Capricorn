...
from Models.ProjectDB import FieldsData
from PySide.QtCore import Qt, SIGNAL, Slot, QPoint
from PySide.QtGui import QWidget, QGroupBox, QTreeView, QStandardItemModel, \
        QVBoxLayout, QMenu, QAction, QStandardItem, QCursor
