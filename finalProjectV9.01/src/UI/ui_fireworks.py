...
from PySide.QtGui import QSortFilterProxyModel, QLabel, QComboBox, QTableView, \
    QStandardItemModel, QLineEdit, QWidget, \
    QGroupBox, QHBoxLayout, QVBoxLayout, QMenu, QAction, QStandardItem, QCursor
