...
from PySide.QtGui import QDialog, QLabel, QComboBox, QTableView, QStandardItemModel, QLineEdit, QIntValidator, QDoubleValidator, \
        QPushButton, QGridLayout, QHBoxLayout, QVBoxLayout, QMenu, QAction, QStandardItem, QCursor
        
import json
import math
import uuid
from Delegate.addCombinationDelegate import AddCombinationDelegate
...
#        self.model.setData(self.model.index(0, 0, QModelIndex()), self.Item)
        ...
        self.view.setItemDelegate(AddCombinationDelegate())
