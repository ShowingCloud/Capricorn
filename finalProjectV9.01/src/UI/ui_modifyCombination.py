...
from PySide.QtGui import QDialog, QLabel, QComboBox, QTableView, QStandardItemModel, \
        QPushButton,QHBoxLayout, QVBoxLayout, QMenu, QAction, QStandardItem, QCursor
