...
class InsertDialog(QDialog):
    ...
    def __init__(self, parent = None):
        ...
        self.TypeEdit.addItems(['A', 'B', 'C', 'D'])
        ...
        aIntValidator = QIntValidator()
        aIntValidator.setRange(0, 10)
        self.ColorEdit.setValidator(aIntValidator)
        
        self.AngleEdit = QLineEdit()
        aIntValidator = QIntValidator()
        self.AngleEdit.setValidator(aIntValidator)
    ...
    def saveData(self):
        with self.sess.begin():
            ...
            record.Color = self.ColorEdit.text()
            record.Angle = self.AngleEdit.text()
