...
#            print 'draw > > '
        ...
        for timeOne in self.igniteTimes:
            ...
            self.bombMedia.stop()
            if dotNow - 5 <= doti and dotNow + 5 >= doti:
                self.bombMedia.play()
                break
...
#        self.bombMedia.setTickInterval(10)
#        output = Phonon.AudioOutput(Phonon.MusicCategory)
#        Phonon.createPath(self.bombMedia, output)
#        path = 'C:/Users/pyroshow/Desktop/musicFile/Rossini.wav'
...
#        path = 'C:/Users/pyroshow/Desktop/musicFile/1_2minutes.wav'
        path = 'C:/Users/pyroshow/Desktop/musicFile/2633_0.3s.wav'
