...
#    #重写自带方法(参数自带)
    ...
    def createEditor (self, parent, option, index):
        ...
        if index.column() == 4 :
            button = QtGui.QMessageBox.question(parent, "Question", "Modification effect of time?", QtGui.QMessageBox.Ok | QtGui.QMessageBox.Cancel, QtGui.QMessageBox.Ok)
        ...
        if index.column() == 8 or index.column() == 10:
            ...
            if button == QtGui.QMessageBox.Ok:
                ...
                chooseIgnitionBox = IgnitionBox(self.session, UUID, another.IgnitorID,  box, self.musicSignal, parent)
