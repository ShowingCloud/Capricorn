...
#        hbox1.addLayout(vbox1)
        ...
        self.fieldFirst = Script("First")
        self.fieldSecond = Script("Second")
        self.fieldThird = Script("Third")
        self.fieldFour = Script("Four")
        self.fieldFive = Script("Five")
        self.fieldSix = Script("Six")
