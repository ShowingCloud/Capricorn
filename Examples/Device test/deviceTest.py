...
class Ui_MainWindow(object):
        ...
        if reply == QtGui.QMessageBox.Yes:
            ...
            if self.radioButtonDelay.isChecked():
                ...
                if self.boxA1Button.isChecked():
                    buttonList1[0] = 1
                    timeList1[0] = int(self.spinBoxA1.text())
                if self.boxA2Button.isChecked():
                    buttonList1[1] = 1
                    timeList1[1] = int(self.spinBoxA2.text())
                if self.boxA3Button.isChecked():
                    buttonList1[2] = 1
                    timeList1[2] = int(self.spinBoxA3.text())
                if self.boxA4Button.isChecked():
                    buttonList1[3] = 1
                    timeList1[3] = int(self.spinBoxA4.text())
                if self.boxA5Button.isChecked():
                    buttonList1[4] = 1
                    timeList1[4] = int(self.spinBoxA5.text())
                if self.boxA6Button.isChecked():
                    buttonList1[5] = 1
                    timeList1[5] = int(self.spinBoxA6.text())
                if self.boxA7Button.isChecked():
                    buttonList1[6] = 1
                    timeList1[6] = int(self.spinBoxA7.text())
                if self.boxA8Button.isChecked():
                    buttonList1[7] = 1
                    timeList1[7] = int(self.spinBoxA8.text())
                if self.boxA9Button.isChecked():
                    buttonList1[8] = 1
                    timeList1[8] = int(self.spinBoxA9.text())
                if self.boxA10Button.isChecked():
                    buttonList1[9] = 1
                    timeList1[9] = int(self.spinBoxA10.text())
                if self.boxA11Button.isChecked():
                    buttonList1[10] = 1
                    timeList1[10] = int(self.spinBoxA11.text())
                if self.boxA12Button.isChecked():
                    buttonList1[11] = 1
                    timeList1[11] = int(self.spinBoxA12.text())
                if self.boxA13Button.isChecked():
                    buttonList1[12] = 1
                    timeList1[12] = int(self.spinBoxA13.text())
                if self.boxA14Button.isChecked():
                    buttonList1[13] = 1
                    timeList1[13] = int(self.spinBoxA14.text())
                if self.boxA15Button.isChecked():
                    buttonList1[14] = 1
                    timeList1[14] = int(self.spinBoxA15.text())
                if self.boxA16Button.isChecked():
                    buttonList1[15] = 1
                    timeList1[15] = int(self.spinBoxA16.text())
                if self.boxB1Button.isChecked():
                    buttonList2[0] = 1
                    timeList2[0] = int(self.spinBoxB1.text())
                if self.boxB2Button.isChecked():
                    buttonList2[1] = 1
                    timeList2[1] = int(self.spinBoxB2.text())
                if self.boxB3Button.isChecked():
                    buttonList2[2] = 1
                    timeList2[2] = int(self.spinBoxB3.text())
                if self.boxB4Button.isChecked():
                    buttonList2[3] = 1
                    timeList2[3] = int(self.spinBoxB4.text())
                if self.boxB5Button.isChecked():
                    buttonList2[4] = 1
                    timeList2[4] = int(self.spinBoxB5.text())
                if self.boxB6Button.isChecked():
                    buttonList2[5] = 1
                    timeList2[5] = int(self.spinBoxB6.text())
                if self.boxB7Button.isChecked():
                    buttonList2[6] = 1
                    timeList2[6] = int(self.spinBoxB7.text())
                if self.boxB8Button.isChecked():
                    buttonList2[7] = 1
                    timeList2[7] = int(self.spinBoxB8.text())
                if self.boxB9Button.isChecked():
                    buttonList2[8] = 1
                    timeList2[8] = int(self.spinBoxB9.text())
                if self.boxB10Button.isChecked():
                    buttonList2[9] = 1
                    timeList2[9] = int(self.spinBoxB10.text())
                if self.boxB11Button.isChecked():
                    buttonList2[10] = 1
                    timeList2[10] = int(self.spinBoxB11.text())
                if self.boxB12Button.isChecked():
                    buttonList2[11] = 1
                    timeList2[11] = int(self.spinBoxB12.text())
                if self.boxB13Button.isChecked():
                    buttonList2[12] = 1
                    timeList2[12] = int(self.spinBoxB13.text())
                if self.boxB14Button.isChecked():
                    buttonList2[13] = 1
                    timeList2[13] = int(self.spinBoxB14.text())
                if self.boxB15Button.isChecked():
                    buttonList2[14] = 1
                    timeList2[14] = int(self.spinBoxB15.text())
                if self.boxB16Button.isChecked():
                    buttonList2[15] = 1
                    timeList2[15] = int(self.spinBoxB16.text())
                ...
                for i in range(16):
                    if buttonList1[i]:
                        print "Box1 firePoint %d ,time=%d s"%((i+1),timeList1[i])                       
                        data['fireBox'] = 0x01
                        data['firePoint'] = i+1
                        data['seconds'] = timeList1[i]
                ...
                for i in range(16):
                    if buttonList2[i]:
                        print "Box2 firePoint %d ,time=%d s"%((i+1),timeList2[i])                       
                        data['fireBox'] = 0x02
                        data['firePoint'] = i+1
                        data['seconds'] = timeList2[i]
                        package = protocol.dataPack(data)
                        package.pack()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButtonNow.setText(_translate("MainWindow", "Fire now", None))
